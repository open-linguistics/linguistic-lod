				   ...
				   <div class="row">
					   <div class="twelve columns">
						   <div class="slider-text">
							   <h1>Linguistic Linked Open Data<span>.</span></h1>
							   <p>Information about the current status of the growing cloud
                                                           of linguistic linked open data.</p>
						   </div>
					   </div>
				   </div>
	   </div> <!-- Flexslider End-->
...
the <a href="https://creativecommons.org/">Creative Commons</a> licenses.</li>
      ...
      <div class="row">
         ...
         <div id="portfolio-wrapper" class="bgrid-quarters s-bgrid-halves">
             ...
             <div class="columns portfolio-item">
                 <div class="item-wrap">
                     <a href="http://linguistics.okfn.org">
                         <img alt="" src="images/okfn.jpg">
                         <div class="overlay"></div>
                         <div class="link-icon"><i class="fa fa-link"></i></div>
                     </a>
                     <div class="portfolio-item-meta">
                         <h5><a href="portfolio.html">OKFN</a></h5>
                         <p>The Open Linguistics Working Group (OWLG)</p>
                     </div>
                 </div>
             </div>
             ...
             <div class="columns portfolio-item">
                 <div class="item-wrap">
                     <a href="http://www.lider-project.eu/">
                         <img alt="" src="images/lider.png">
                         <div class="overlay"></div>
                         <div class="link-icon"><i class="fa fa-link"></i></div>
                     </a>
                     <div class="portfolio-item-meta">
                         <h5><a href="portfolio.html">LIDER</a></h5>
                         <p>Linked Data as an Enabler for Enterprise</p>
                     </div>
                 </div>
             </div>
             ...
             <div class="columns portfolio-item s-first">
                 <div class="item-wrap">
                     <a href="http://ldl2015.linguistic-lod.org/">
                         <img alt="" src="images/ldl2015.jpg">
                         <div class="overlay"></div>
                         <div class="link-icon"><i class="fa fa-link"></i></div>
                     </a>
                     <div class="portfolio-item-meta">
                         <h5><a href="portfolio.html">LDL-2015</a></h5>
                         <p>The 4<sup>th</sup> Workshop on Linked Data in Linguistics (Beijing, July 2015).</p>
                     </div>
                 </div>
             </div>
             ...
             <div class="columns portfolio-item">
                 <div class="item-wrap">
                     <a href="http://linghub.lider-project.eu/">
                         <img alt="" src="images/linghub.png">
                         <div class="overlay"></div>
                         <div class="link-icon"><i class="fa fa-link"></i></div>
                     </a>
                     <div class="portfolio-item-meta">
                         <h5><a href="portfolio.html">LingHub</a></h5>
                         <p>Linguistic Metadata Repository</p>
                     </div>
                 </div>
             </div>
   ...
   <section id="journal">
      ...
      <div class="row">
         <div class="twelve columns align-center">
            <h1>More information about LLOD.</h1>
         </div>
      </div>
      ...
      <div class="blog-entries">
         ...
         <article class="row entry">
            ...
            <div class="entry-header">
               ...
               <div class="permalink">
                  <a href="http://wiki.okfn.org/Working_Groups/Linguistics/How_to_contribute"><i class="fa fa-link"></i></a>
               </div>

               <div class="ten columns entry-title pull-right">
                  <h3><a href="http://wiki.okfn.org/Working_Groups/Linguistics/How_to_contribute">How to contribute to the LLOD cloud.</a></h3>
               </div>
